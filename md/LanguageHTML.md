...
Remarque:
Une balise `<button type="button"></button>` a été spécifiquement créée pour les boutons.


On peut écrire le JS directement :
- dans le fichier HTML entre les balises `<script></script>`
